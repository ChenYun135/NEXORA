...
export const metadata:Metadata={title,description,openGraph:{title,description,images:[{url:"/policy-og.png",width:1733,height:909,alt:"NEXORA Policy Intelligence"}]},twitter:{card:"summary_large_image",title,description,images:["/policy-og.png"]}};
