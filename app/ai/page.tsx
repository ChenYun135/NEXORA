...
export const metadata:Metadata={title,description,alternates:{canonical:"/ai"},openGraph:{title,description,images:[{url:"/ai-og.png",width:1200,height:630,alt:"NEXORA AI evidence-based intelligence for emerging industries"}]},twitter:{card:"summary_large_image",title,description,images:["/ai-og.png"]}};
