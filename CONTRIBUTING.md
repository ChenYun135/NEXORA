...
New datasets require provider terms review, field-level provenance, time/geography definitions, missing-data behavior, and a reproducible validation path. Security reports should follow [SECURITY.md](SECURITY.md), not a public issue.
