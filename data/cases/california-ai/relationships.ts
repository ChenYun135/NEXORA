...
export const californiaAIRelationships = snapshot.relationships.slice(0, 40).map((edge, index) => ({
  ...
  coverageNote: "Verified within the 16-institution top-200-derived coverage frame; not a complete California collaboration graph.",
}));
