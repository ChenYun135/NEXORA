...
export const californiaAICalibration = [
  ...
  { variable: "Talent capacity", status: "CONTEXTUAL_PROXY", source: "BLS OEWS San Jose-Sunnyvale-Santa Clara MSA, May 2025", note: "Regional AI-adjacent occupational context only; it does not calibrate statewide talent capacity." },
  { variable: "Commercialization", status: "ASSUMPTION", source: null, note: "No AI startup-formation series; Census BFS is not relabeled." },
  { variable: "Public funding", status: "CONTEXTUAL_INPUT", source: "NSF 2025 title-qualified awards", note: "Nominal obligations from one agency/year; input context, not innovation effectiveness calibration." },
  { variable: "Capital availability", status: "UNAVAILABLE", source: null, note: "No source passed feasibility gate." },
  { variable: "Patent activity", status: "UNAVAILABLE", source: null, note: "USPTO production access is not configured." },
] as const;
