...
export const californiaAICoverage: { id: string; label: { en: string; zh: string }; level: CoverageLevel; note: { en: string; zh: string } }[] = [
  ...
  { id: "patents", label: { en: "Patents", zh: "专利" }, level: "UNAVAILABLE", note: { en: "USPTO adapter status is NOT_CONFIGURED; no production or Demo patent count is used.", zh: "USPTO 适配器状态为 NOT_CONFIGURED；未使用生产或 Demo 专利计数。" } },
  ...
  { id: "talent", label: { en: "Talent", zh: "人才" }, level: "PARTIAL", note: { en: "Five May 2025 BLS OEWS indicators for the San Jose-Sunnyvale-Santa Clara MSA; AI-adjacent technical workforce, not AI workers or statewide talent.", zh: "五项 2025 年 5 月圣何塞—森尼韦尔—圣克拉拉都会统计区 BLS OEWS 指标；表示 AI 邻近技术劳动力，不是 AI 从业人数或全州人才。" } },
