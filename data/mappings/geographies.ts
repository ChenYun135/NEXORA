...
export const californiaAICanonicalGeographies:CanonicalGeography[]=[
 ...
 {id:"sf-bay-area",type:"METRO_ECOSYSTEM",name:{en:"San Francisco Bay Area",zh:"旧金山湾区"},countryCode:"US",parentId:"california",latitude:37.7749,longitude:-122.4194,sourceIds:["ca-ai-case-v1.0"]},
 {id:"los-angeles",type:"METRO_ECOSYSTEM",name:{en:"Los Angeles",zh:"洛杉矶"},countryCode:"US",parentId:"california",latitude:34.0522,longitude:-118.2437,sourceIds:["ca-ai-case-v1.0"]},
 {id:"san-diego",type:"METRO_ECOSYSTEM",name:{en:"San Diego",zh:"圣迭戈"},countryCode:"US",parentId:"california",latitude:32.7157,longitude:-117.1611,sourceIds:["ca-ai-case-v1.0"]},
 {id:"orange-county",type:"METRO_ECOSYSTEM",name:{en:"Orange County / Irvine",zh:"橙县／尔湾"},countryCode:"US",parentId:"california",latitude:33.6846,longitude:-117.8265,sourceIds:["ca-ai-case-v1.0"]},
 {id:"sacramento",type:"METRO_ECOSYSTEM",name:{en:"Sacramento / policy context",zh:"萨克拉门托／政策语境"},countryCode:"US",parentId:"california",latitude:38.5816,longitude:-121.4944,sourceIds:["ca-ai-case-v1.0"]},
];
