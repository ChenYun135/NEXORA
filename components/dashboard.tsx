...
const modules = [
  { id:"atlas", href:"/atlas", art:"atlas", name:{en:"Atlas",zh:"全球产业图谱"}, question:{en:"Where are tomorrow’s industries taking shape?",zh:"未来产业正在何处形成"},body:{en:"Explore emerging industries, research hubs and innovation ecosystems across regions.",zh:"探索各地区的新兴产业、科研枢纽与创新生态"},highlights:{en:["Geography","Specialization","Regional comparison"],zh:["创新地理","专业化","区域比较"]}},
  { id:"radar", href:"/radar", art:"radar", name:{en:"Radar",zh:"未来产业雷达"}, question:{en:"Which signals deserve closer investigation?",zh:"哪些前沿信号值得深入研究"},body:{en:"Detect technology momentum and trace the evidence behind each signal.",zh:"识别技术动能，并追溯每项信号背后的证据"},highlights:{en:["Momentum","Opportunity","Evidence trail"],zh:["技术动能","机会识别","证据链"]}},
  { id:"ecosystems", href:"/ecosystems", art:"ecosystems", name:{en:"Ecosystems",zh:"创新生态"}, question:{en:"How does innovation move through institutions?",zh:"创新如何在机构之间流动"},body:{en:"Understand the institutions, bridges and flows behind innovation.",zh:"理解创新背后的机构、桥接关系与知识流动"},highlights:{en:["Networks","Bridges","Knowledge flows"],zh:["网络结构","桥接关系","知识流动"]}},
  { id:"policy", href:"/policy", art:"policy", name:{en:"Policy",zh:"政策智能"}, question:{en:"Through which mechanisms may policy shape innovation?",zh:"政策可能通过哪些机制影响创新"},body:{en:"Study instruments, targets, implementation pathways and evidence boundaries.",zh:"研究政策工具、作用对象、实施路径与证据边界"},highlights:{en:["Instruments","Mechanisms","Implementation"],zh:["政策工具","作用机制","实施过程"]}},
  { id:"organizations", href:"/companies", art:"organizations", name:{en:"Organizations",zh:"组织智能"}, question:{en:"Which institutions structure emerging ecosystems?",zh:"哪些机构塑造新兴产业生态"},body:{en:"Explore institutional roles, relationships and public evidence.",zh:"探索机构角色、关联网络与公共证据"},highlights:{en:["Roles","Relationships","Evidence"],zh:["机构角色","关系网络","公共证据"]}},
  { id:"data", href:"/data-status", art:"data-status", name:{en:"Data Status",zh:"数据状态"}, question:{en:"Is the evidence ready for research?",zh:"现有证据是否达到研究要求"},body:{en:"Inspect provenance, quality, freshness and the limits of current evidence.",zh:"审视数据来源、质量、时效与现有证据边界"},highlights:{en:["Provenance","Quality","Freshness"],zh:["数据来源","质量状态","更新时效"]}},
  { id:"ai", href:"/ai", art:"ai", name:{en:"NEXORA AI",zh:"NEXORA AI"}, question:{en:"What can the available evidence support?",zh:"现有证据能够支持哪些判断"},body:{en:"Move from bounded research questions to source-aware interpretation.",zh:"从边界清晰的研究问题出发，形成有来源的审慎解读"},highlights:{en:["Question","Evidence","Interpretation"],zh:["研究问题","证据检索","审慎解读"]}},
  { id:"simulator", href:"/simulator", art:"simulator", name:{en:"Simulator",zh:"情景模拟器"}, question:{en:"How do assumptions change possible trajectories?",zh:"不同假设如何改变可能的演化路径"},body:{en:"Explore mechanisms, delays and scenarios without treating simulation as prediction.",zh:"探索机制、时滞与情景，同时明确模拟并非预测"},highlights:{en:["Mechanisms","Delays","Trajectories"],zh:["作用机制","时间滞后","情景轨迹"]}},
] as const;
