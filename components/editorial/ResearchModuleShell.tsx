...
const evidenceSummary: Record<string, { metrics: Array<[string, Localized, string]>; findings: Array<[Localized, Localized, string]> }> = {
  ...
  "data-status":{metrics:[["20",{en:"provider families",zh:"个数据源家族"},"OBSERVED"],["13",{en:"Tier A definitions",zh:"个 Tier A 定义"},"OBSERVED"],["4",{en:"Tier A ready",zh:"个 Tier A 已就绪"},"OBSERVED"]],findings:[[{en:"Operational coverage expanded without lowering the gate",zh:"运营覆盖在不降低门槛的前提下扩展"},{en:"BLS QCEW and Federal Register now have frozen 2015–2023 public aggregates.",zh:"BLS QCEW 与 Federal Register 现已形成 2015–2023 年冻结公共聚合"},"OBSERVED"],[{en:"Unavailable never becomes zero",zh:"不可用状态不会被转换为零"},{en:"Missing, suppressed and observed-zero remain separate states.",zh:"缺失、受抑制与明确观测为零保持不同状态"},"OBSERVED"],[{en:"READY is product-boundary specific",zh:"已就绪状态限定于具体产品边界"},{en:"A provider can remain partially unactivated even when one tested product is ready.",zh:"即使某个经过测试的产品已经就绪，同一来源的其他产品仍可能未激活"},"INTERPRETATION"]]},
