...
const evidenceSummary: Record<string, { metrics: Array<[string, Localized, string]>; findings: Array<[Localized, Localized, string]> }> = {
  ...
  "data-status":{metrics:[["20",{en:"provider families",zh:"个数据源家族"},"OBSERVED"],["13",{en:"Tier A definitions",zh:"个 Tier A 定义"},"OBSERVED"],["2",{en:"Tier A ready",zh:"个 Tier A 已就绪"},"OBSERVED"]],findings:[[{en:"The catalog is broader than production coverage",zh:"数据源目录广于生产覆盖"},{en:"Only verified snapshots and controlled official records are marked ready.",zh:"只有经过验证的快照与受控官方记录才标记为已就绪"},"OBSERVED"],[{en:"Unavailable never becomes zero",zh:"不可用状态不会被转换为零"},{en:"Missing, suppressed and observed-zero remain separate states.",zh:"缺失、受抑制与明确观测为零保持不同状态"},"OBSERVED"],[{en:"Trust depends on provenance and freshness",zh:"可信度同时依赖来源与时效"},{en:"Evidence needs attributable sources, transformations, versions and refresh context.",zh:"证据需要可归属来源、转换过程、版本与更新时间背景"},"INTERPRETATION"]]},
