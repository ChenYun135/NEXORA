...
const evidenceSummary: Record<string, { metrics: Array<[string, Localized, string]>; findings: Array<[Localized, Localized, string]> }> = {
  ...
  "data-status":{metrics:[["20",{en:"provider families",zh:"个数据源家族"},"OBSERVED"],["13",{en:"Tier A definitions",zh:"个 Tier A 定义"},"OBSERVED"],["9",{en:"Tier A ready",zh:"个 Tier A 已就绪"},"OBSERVED"]],findings:[[{en:"Operational coverage expanded without lowering the gate",zh:"运营覆盖在不降低门槛的前提下扩展"},{en:"R3 adds frozen 2015–2023 California aggregates from BFS, BDS, HERD, SBIR/STTR and BEA.",zh:"R3 新增 BFS、BDS、HERD、SBIR/STTR 与 BEA 的 2015–2023 年加州冻结聚合数据"},"OBSERVED"],[{en:"Applications and realized dynamics stay separate",zh:"申请活动与实际企业动态保持区分"},{en:"BFS applications are not treated as startups; BDS firm-age cohorts provide the realized series.",zh:"BFS 申请不会被当作初创企业；BDS 企业年龄队列提供实际动态序列"},"OBSERVED"],[{en:"Support is not commercialization success",zh:"项目支持不等于商业化成功"},{en:"SBIR/STTR phase and amount aggregates measure public support only.",zh:"SBIR/STTR 阶段与金额聚合仅衡量公共支持"},"INTERPRETATION"]]},
